...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            ...
            description: post.frontmatter.description,
            url: `https://clicknstart.in/blog/${slug}`,
            type: 'article',
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const jsonLd = {
        ...
        "mainEntityOfPage": `https://clicknstart.in/blog/${slug}`
    };
                    ...
                    <div className="max-w-3xl mx-auto px-4 py-12 lg:py-16">
                        ...
                        <div className="mt-16 pt-8 border-t border-slate-200">
                            ...
                            <div className="flex gap-4">
                                <a
                                    href={`https://twitter.com/intent/tweet?url=https://clicknstart.in/blog/${slug}&text=${encodeURIComponent(post.frontmatter.title)}`}
                                    target="_blank"
                                ...
                                <a
                                    href={`https://www.facebook.com/sharer/sharer.php?u=https://clicknstart.in/blog/${slug}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                ...
                                <a
                                    href={`https://api.whatsapp.com/send?text=${encodeURIComponent(post.frontmatter.title + ' https://clicknstart.in/blog/' + slug)}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
